...
// function InMemoryStorage() { //хранилище, в котором домен(с таблицами сущностей). (
//                             //в таблице два свойства: его имя(иначе сущность - магазин, продукт и т д) и
//                             //что в ней содержится: список из объектов с data и id
//   };
...
// InMemoryStorage.createStorage = function () {
//   var stor = new InMemoryStorage();
//   stor.ListOfData = {}; //в нем таблицы сущностей

//   stor.domains.entityName; // domain.entity - Shop, Product etc
